...
#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, ns, equivalent_condition)                   \
    namespace {                                                                                 \
    ...
    namespace ns {                                                                              \
    std::error_code make_error_code(enumclass value) {                                          \
...
#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_API(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_AUTO_RETURN(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::auto_return, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_AUTOWALK(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::autowalk, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_KEEPALIVE(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::keepalive, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_LOG_STATUS(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::log_status, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_SPOT(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::spot, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_MISSION(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::mission, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_GRAPHNAV(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::graph_nav, equivalent_condition)

#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_METRICS(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::metrics_logging, equivalent_condition)
...
#define DEFINE_PROTO_ENUM_ERRORCODE_IMPL_DOCKING(enumclass, equivalent_condition) \
    DEFINE_PROTO_ENUM_ERRORCODE_IMPL(enumclass, bosdyn::api::docking, equivalent_condition)
