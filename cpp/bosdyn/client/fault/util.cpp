...
::bosdyn::api::ServiceFault MakeServiceFault(const std::string& fault_name,
...
::bosdyn::api::ServiceFault MakePayloadFault(const std::string& fault_name,
                                             const std::string& payload_guid,
                                             const std::string& error_message,
                                             ::bosdyn::api::ServiceFault::Severity severity,
                                             const std::vector<std::string>& attributes) {
    ::bosdyn::api::ServiceFault service_fault;
