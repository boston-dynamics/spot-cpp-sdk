...
std::shared_future<RobotIdResultType> RobotIdClient::GetAsync(const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::RobotIdRequest, ::bosdyn::api::RobotIdResponse,
                          ::bosdyn::api::RobotIdResponse>(
            request,
            std::bind(&::bosdyn::api::RobotIdService::StubInterface::AsyncGetRobotId, m_stub.get(),
                      _1, _2, _3),
...
void RobotIdClient::OnGetRobotIdComplete(MessagePumpCallBase* call,
                                         ...
                                         ::bosdyn::api::RobotIdResponse&& response,
                                         const grpc::Status& status,
                                         std::promise<RobotIdResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::RobotIdResponse>(status, response,
