...
DataAcquisitionStoreClient::ListCaptureActionsAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListCaptureActionsRequest,
...
void DataAcquisitionStoreClient::OnListCaptureActionsComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListCaptureActionsResponse>(
...
DataAcquisitionStoreClient::ListStoredDataAsync(::bosdyn::api::ListStoredDataRequest& request,
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListStoredDataRequest,
...
void DataAcquisitionStoreClient::OnListStoredDataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListStoredDataResponse>(
            status, response, SDKErrorCode::Success);
...
void DataAcquisitionStoreClient::OnStoreDataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::StoreDataResponse>(status, response,
...
DataAcquisitionStoreClient::ListStoredImagesAsync(::bosdyn::api::ListStoredImagesRequest& request,
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListStoredImagesRequest,
...
void DataAcquisitionStoreClient::OnListStoredImagesComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListStoredImagesResponse>(
            status, response, SDKErrorCode::Success);
...
void DataAcquisitionStoreClient::OnStoreImageComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::StoreImageResponse>(status, response,
                                                                            SDKErrorCode::Success);
...
DataAcquisitionStoreClient::ListStoredMetadataAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListStoredMetadataRequest,
...
void DataAcquisitionStoreClient::OnListStoredMetadataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListStoredMetadataResponse>(
            status, response, SDKErrorCode::Success);
...
void DataAcquisitionStoreClient::OnStoreMetadataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::StoreMetadataResponse>(
            status, response, SDKErrorCode::Success);
...
DataAcquisitionStoreClient::ListStoredAlertDataAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListStoredAlertDataRequest,
...
void DataAcquisitionStoreClient::OnListStoredAlertDataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListStoredAlertDataResponse>(
            status, response, SDKErrorCode::Success);
...
DataAcquisitionStoreClient::StoreAlertDataAsync(::bosdyn::api::StoreAlertDataRequest& request,
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::StoreAlertDataRequest,
...
void DataAcquisitionStoreClient::OnStoreAlertDataComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::StoreAlertDataResponse>(
            status, response, SDKErrorCode::Success);
