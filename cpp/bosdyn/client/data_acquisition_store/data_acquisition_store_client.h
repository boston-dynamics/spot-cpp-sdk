...
typedef Result<::bosdyn::api::ListCaptureActionsResponse>
    DataAcquisitionStoreListCaptureActionsResultType;
...
typedef Result<::bosdyn::api::ListStoredImagesResponse>
    DataAcquisitionStoreListStoredImagesResultType;
typedef Result<::bosdyn::api::StoreImageResponse> DataAcquisitionStoreStoreImageResultType;
typedef Result<::bosdyn::api::ListStoredMetadataResponse>
    DataAcquisitionStoreListStoredMetadataResultType;
...
class DataAcquisitionStoreClient : public ServiceClient {
 public:
    ...
    std::shared_future<DataAcquisitionStoreListCaptureActionsResultType> ListCaptureActionsAsync(
        ::bosdyn::api::ListCaptureActionsRequest& request,
    ...
    std::shared_future<DataAcquisitionStoreListStoredDataResultType> ListStoredDataAsync(
        ::bosdyn::api::ListStoredDataRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreStoreDataResultType> StoreDataAsync(
        ::bosdyn::api::StoreDataRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreListStoredImagesResultType> ListStoredImagesAsync(
        ::bosdyn::api::ListStoredImagesRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreStoreImageResultType> StoreImageAsync(
        ::bosdyn::api::StoreImageRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreListStoredMetadataResultType> ListStoredMetadataAsync(
        ::bosdyn::api::ListStoredMetadataRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreStoreMetadataResultType> StoreMetadataAsync(
        ::bosdyn::api::StoreMetadataRequest& request,
        const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<DataAcquisitionStoreListStoredAlertDataResultType> ListStoredAlertDataAsync(
        ::bosdyn::api::ListStoredAlertDataRequest& request,
        const RPCParameters& parameters = RPCParameters());
 ...
 private:
    ...
    void OnStoreDataComplete(MessagePumpCallBase* call,
                             const ::bosdyn::api::StoreDataRequest& request,
                             ::bosdyn::api::StoreDataResponse&& response,
    ...
    void OnStoreImageComplete(MessagePumpCallBase* call,
                              const ::bosdyn::api::StoreImageRequest& request,
                              ::bosdyn::api::StoreImageResponse&& response,
                              const grpc::Status& status,
    ...
    void OnStoreMetadataComplete(MessagePumpCallBase* call,
                                 ...
                                 ::bosdyn::api::StoreMetadataResponse&& response,
                                 const grpc::Status& status,
