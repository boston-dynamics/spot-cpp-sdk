...
class MissionClient : public ServiceClient {
 public:
    ...
    // Start executing a loaded mission. This will not restart a mission that has completed fully -
    // to do that, use RestartMission. Note: the PlayMission RPC requires a lease. By default, we
    // use a body lease, however other resources (or no resources) can be provided to change which
    // leases are attached to the request.
    ...
    GetStateResultType GetState(::bosdyn::api::mission::GetStateRequest& request,
                                const RPCParameters& parameters = RPCParameters());
    ...
    std::shared_future<GetInfoResultType> GetInfoAsChunksAsync(const RPCParameters& parameters);

    GetMissionResultType GetMission(::bosdyn::api::mission::GetMissionRequest& request,
                                    const RPCParameters& parameters = RPCParameters());
    ...
    AnswerQuestionResultType AnswerQuestion(::bosdyn::api::mission::AnswerQuestionRequest& request,
                                            const RPCParameters& parameters = RPCParameters());
 ...
 private:
    ...
    void OnLoadMissionComplete(MessagePumpCallBase* call,
    ...
    void OnLoadMissionAsChunksComplete(MessagePumpCallBase* call,
                                       const std::vector<::bosdyn::api::DataChunk>&& request,
                                       ::bosdyn::api::mission::LoadMissionResponse&& response,
                                       const grpc::Status& status,
                                       std::promise<LoadMissionResultType> promise);

    void OnLoadMissionAsChunks2Complete(MessagePumpCallBase* call,
                                        const std::vector<::bosdyn::api::DataChunk>&& requests,
                                        std::vector<::bosdyn::api::DataChunk>&& responses,
                                        const grpc::Status& status,
                                        std::promise<LoadMissionResultType> promise);

    void OnPauseMissionComplete(MessagePumpCallBase* call,
                                const ::bosdyn::api::mission::PauseMissionRequest& request,
                                ::bosdyn::api::mission::PauseMissionResponse&& response,
                                const grpc::Status& status,
                                std::promise<PauseMissionResultType> promise);

    void OnPlayMissionComplete(MessagePumpCallBase* call,
    ...
    void OnRestartMissionComplete(MessagePumpCallBase* call,
                                  const ::bosdyn::api::mission::RestartMissionRequest& request,
                                  ::bosdyn::api::mission::RestartMissionResponse&& response,
                                  const grpc::Status& status,
                                  std::promise<RestartMissionResultType> promise);

    void OnGetStateComplete(MessagePumpCallBase* call,
                            const ::bosdyn::api::mission::GetStateRequest& request,
                            ::bosdyn::api::mission::GetStateResponse&& response,
                            const grpc::Status& status, std::promise<GetStateResultType> promise);

    void OnGetInfoComplete(MessagePumpCallBase* call,
                           const ::bosdyn::api::mission::GetInfoRequest& request,
                           ::bosdyn::api::mission::GetInfoResponse&& response,
                           const grpc::Status& status, std::promise<GetInfoResultType> promise);
    ...
    void OnGetMissionComplete(MessagePumpCallBase* call,
    ...
    void OnGetMissionAsChunksComplete(MessagePumpCallBase* call,
                                      const ::bosdyn::api::mission::GetMissionRequest& request,
                                      std::vector<::bosdyn::api::DataChunk>&& responses,
                                      const grpc::Status& status,
                                      std::promise<GetMissionResultType> promise);

    void OnAnswerQuestionComplete(MessagePumpCallBase* call,
                                  const ::bosdyn::api::mission::AnswerQuestionRequest& request,
                                  ::bosdyn::api::mission::AnswerQuestionResponse&& response,
                                  const grpc::Status& status,
                                  std::promise<AnswerQuestionResultType> promise);

    std::unique_ptr<::bosdyn::api::mission::MissionService::StubInterface> m_stub;
