...
ListWorldObjectsResultType WorldObjectClient::ListWorldObjects(const RPCParameters& parameters) {
...
std::shared_future<ListWorldObjectsResultType> WorldObjectClient::ListWorldObjectsAsync(
    ::bosdyn::api::ListWorldObjectRequest& request, const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListWorldObjectRequest,
                                                      ::bosdyn::api::ListWorldObjectResponse,
                                                      ::bosdyn::api::ListWorldObjectResponse>(
        request,
        std::bind(&::bosdyn::api::WorldObjectService::StubInterface::AsyncListWorldObjects,
                  m_stub.get(), _1, _2, _3),
...
void WorldObjectClient::OnListWorldObjectsComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListWorldObjectResponse>(
...
std::shared_future<MutateWorldObjectsResultType> WorldObjectClient::MutateWorldObjectsAsync(
    ::bosdyn::api::MutateWorldObjectRequest& request, const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::MutateWorldObjectRequest,
                                                      ::bosdyn::api::MutateWorldObjectResponse,
                                                      ::bosdyn::api::MutateWorldObjectResponse>(
        request,
        std::bind(&::bosdyn::api::WorldObjectService::StubInterface::AsyncMutateWorldObjects,
                  m_stub.get(), _1, _2, _3),
...
void WorldObjectClient::OnMutateWorldObjectsComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::MutateWorldObjectResponse>(
