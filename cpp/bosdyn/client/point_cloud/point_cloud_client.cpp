...
std::shared_future<ListPointCloudSourcesResultType> PointCloudClient::ListPointCloudSourcesAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::ListPointCloudSourcesRequest,
                                                      ::bosdyn::api::ListPointCloudSourcesResponse,
                                                      ::bosdyn::api::ListPointCloudSourcesResponse>(
        request,
        std::bind(&::bosdyn::api::PointCloudService::StubInterface::AsyncListPointCloudSources,
                  m_stub.get(), _1, _2, _3),
...
void PointCloudClient::OnListSourcesComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::ListPointCloudSourcesResponse>(
...
std::shared_future<GetPointCloudResultType> PointCloudClient::GetPointCloudAsync(
    const std::vector<std::string>& point_cloud_sources, const RPCParameters& parameters) {
    ...
    for (const std::string& source : point_cloud_sources) {
        ::bosdyn::api::PointCloudRequest* proto_point_cloud_request =
            request.add_point_cloud_requests();
...
std::shared_future<GetPointCloudResultType> PointCloudClient::GetPointCloudAsync(
    ::bosdyn::api::GetPointCloudRequest& request, const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::GetPointCloudRequest, ::bosdyn::api::GetPointCloudResponse,
            ...
            request,
            std::bind(&::bosdyn::api::PointCloudService::StubInterface::AsyncGetPointCloud,
                      m_stub.get(), _1, _2, _3),
...
void PointCloudClient::OnGetPointCloudComplete(MessagePumpCallBase*,
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::GetPointCloudResponse>(
            status, response, SDKErrorCode::Success);
        ...
        if (code != SuccessCondition::Success) {
            promise.set_value(
                {::bosdyn::common::Status(
                     code, "PointCloudResponse ::bosdyn::common::Status unsuccessful"),
                 std::move(response)});
            return;
        }
    }
