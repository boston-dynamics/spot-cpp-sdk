...
class VersionClient : public ServiceClient {
 public:
    ...
    // Get the default service name the spotcam version service will be registered in the directory
    // with.
    static std::string GetDefaultServiceName() { return s_default_service_name; }

    // Get the default service type for the spot cam version service that will be registered in the
    // directory.
 ...
 private:
    ...
    void OnGetSoftwareVersionComplete(
        ...
        const ::bosdyn::api::spot_cam::GetSoftwareVersionRequest& request,
    ...
    std::unique_ptr<::bosdyn::api::spot_cam::VersionService::StubInterface> m_stub;
