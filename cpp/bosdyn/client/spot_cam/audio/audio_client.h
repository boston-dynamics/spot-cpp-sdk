...
typedef Result<::bosdyn::api::spot_cam::SetAudioCaptureChannelResponse>
    SetAudioCaptureChannelResultType;
typedef Result<::bosdyn::api::spot_cam::GetAudioCaptureChannelResponse>
    GetAudioCaptureChannelResultType;
...
class AudioClient : public ServiceClient {
 public:
    ...
    std::shared_future<PlaySoundResultType> PlaySoundAsync(
        const std::string& sound_name, const RPCParameters& parameters = RPCParameters());

    PlaySoundResultType PlaySound(const std::string& sound_name, float gain,
                                  const RPCParameters& parameters = RPCParameters());

    PlaySoundResultType PlaySound(const std::string& sound_name,
                                  const RPCParameters& parameters = RPCParameters());
    ...
    PlaySoundResultType PlaySound(::bosdyn::api::spot_cam::PlaySoundRequest& request,
                                  const RPCParameters& parameters = RPCParameters());

    std::shared_future<DeleteSoundResultType> DeleteSoundAsync(
        const std::string& sound_name, const RPCParameters& parameters = RPCParameters());

    DeleteSoundResultType DeleteSound(const std::string& sound_name,
                                      const RPCParameters& parameters = RPCParameters());
    ...
    DeleteSoundResultType DeleteSound(::bosdyn::api::spot_cam::DeleteSoundRequest& request,
                                      const RPCParameters& parameters = RPCParameters());

    std::shared_future<ListSoundsResultType> ListSoundsAsync(
        const RPCParameters& parameters = RPCParameters());
    ListSoundsResultType ListSounds(const RPCParameters& parameters = RPCParameters());

    std::shared_future<SetVolumeResultType> SetVolumeAsync(
        float percentage, const RPCParameters& parameters = RPCParameters());

    SetVolumeResultType SetVolume(float percentage,
                                  const RPCParameters& parameters = RPCParameters());
    ...
    SetVolumeResultType SetVolume(::bosdyn::api::spot_cam::SetVolumeRequest& request,
                                  const RPCParameters& parameters = RPCParameters());

    std::shared_future<GetVolumeResultType> GetVolumeAsync(
        const RPCParameters& parameters = RPCParameters());

    GetVolumeResultType GetVolume(const RPCParameters& parameters = RPCParameters());
    ...
    // Get the default service name the spot cam audio service will be registered in the directory
    // with.
    static std::string GetDefaultServiceName() { return s_default_service_name; }

    // Get the default service type for the spot cam audio service that will be registered in the
    // directory.
    static std::string GetServiceType() { return s_service_type; }

 private:
    // Callback function registered for the asynchronous grpc calls.
    void OnPlaySoundComplete(MessagePumpCallBase* call,
                             const ::bosdyn::api::spot_cam::PlaySoundRequest& request,
                             ::bosdyn::api::spot_cam::PlaySoundResponse&& response,
                             const grpc::Status& status, std::promise<PlaySoundResultType> promise);
    void OnDeleteSoundComplete(MessagePumpCallBase* call,
    ...
    void OnListSoundsComplete(MessagePumpCallBase* call,
    ...
    void OnSetVolumeComplete(MessagePumpCallBase* call,
                             const ::bosdyn::api::spot_cam::SetVolumeRequest& request,
                             ::bosdyn::api::spot_cam::SetVolumeResponse&& response,
                             const grpc::Status& status, std::promise<SetVolumeResultType> promise);
    void OnGetVolumeComplete(MessagePumpCallBase* call,
                             const ::bosdyn::api::spot_cam::GetVolumeRequest& request,
                             ::bosdyn::api::spot_cam::GetVolumeResponse&& response,
                             const grpc::Status& status, std::promise<GetVolumeResultType> promise);
    void OnSetAudioCaptureChannelComplete(
        ...
        ::bosdyn::api::spot_cam::SetAudioCaptureChannelResponse&& response,
        const grpc::Status& status, std::promise<SetAudioCaptureChannelResultType> promise);
    void OnGetAudioCaptureChannelComplete(
        MessagePumpCallBase* call,
        const ::bosdyn::api::spot_cam::GetAudioCaptureChannelRequest& request,
        ::bosdyn::api::spot_cam::GetAudioCaptureChannelResponse&& response,
        const grpc::Status& status, std::promise<GetAudioCaptureChannelResultType> promise);
    void OnSetAudioCaptureGainComplete(
        MessagePumpCallBase* call,
        const ::bosdyn::api::spot_cam::SetAudioCaptureGainRequest& request,
    ...
    void OnGetAudioCaptureGainComplete(
        MessagePumpCallBase* call,
        const ::bosdyn::api::spot_cam::GetAudioCaptureGainRequest& request,
