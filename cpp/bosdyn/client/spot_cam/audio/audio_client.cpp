...
std::shared_future<PlaySoundResultType> AudioClient::PlaySoundAsync(
    const std::string& sound_name, float gain, const RPCParameters& parameters) {
...
PlaySoundResultType AudioClient::PlaySound(const std::string& sound_name, float gain,
                                           const RPCParameters& parameters) {
    return PlaySoundAsync(sound_name, gain, parameters).get();
}

PlaySoundResultType AudioClient::PlaySound(const std::string& sound_name,
                                           const RPCParameters& parameters) {
    return PlaySoundAsync(sound_name, parameters).get();
}

std::shared_future<PlaySoundResultType> AudioClient::PlaySoundAsync(
    ::bosdyn::api::spot_cam::PlaySoundRequest& request, const RPCParameters& parameters) {
    std::promise<PlaySoundResultType> response;
    std::shared_future<PlaySoundResultType> future = response.get_future();
    BOSDYN_ASSERT_PRECONDITION(m_stub != nullptr, "Stub for service is unset!");

    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::PlaySoundRequest,
...
PlaySoundResultType AudioClient::PlaySound(::bosdyn::api::spot_cam::PlaySoundRequest& request,
                                           const RPCParameters& parameters) {
    return PlaySoundAsync(request, parameters).get();
}

void AudioClient::OnPlaySoundComplete(MessagePumpCallBase* call,
                                      const ::bosdyn::api::spot_cam::PlaySoundRequest& request,
                                      ::bosdyn::api::spot_cam::PlaySoundResponse&& response,
                                      const grpc::Status& status,
                                      std::promise<PlaySoundResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::PlaySoundResponse>(
...
DeleteSoundResultType AudioClient::DeleteSound(const std::string& sound_name,
                                               const RPCParameters& parameters) {
    return DeleteSoundAsync(sound_name, parameters).get();
}

std::shared_future<DeleteSoundResultType> AudioClient::DeleteSoundAsync(
    ::bosdyn::api::spot_cam::DeleteSoundRequest& request, const RPCParameters& parameters) {
    std::promise<DeleteSoundResultType> response;
    std::shared_future<DeleteSoundResultType> future = response.get_future();
    BOSDYN_ASSERT_PRECONDITION(m_stub != nullptr, "Stub for service is unset!");

    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::DeleteSoundRequest,
...
DeleteSoundResultType AudioClient::DeleteSound(::bosdyn::api::spot_cam::DeleteSoundRequest& request,
                                               const RPCParameters& parameters) {
    return DeleteSoundAsync(request, parameters).get();
}

void AudioClient::OnDeleteSoundComplete(MessagePumpCallBase* call,
                                        const ::bosdyn::api::spot_cam::DeleteSoundRequest& request,
                                        ::bosdyn::api::spot_cam::DeleteSoundResponse&& response,
                                        const grpc::Status& status,
                                        std::promise<DeleteSoundResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::DeleteSoundResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<ListSoundsResultType> AudioClient::ListSoundsAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::ListSoundsRequest,
...
ListSoundsResultType AudioClient::ListSounds(const RPCParameters& parameters) {
    return ListSoundsAsync(parameters).get();
}

void AudioClient::OnListSoundsComplete(MessagePumpCallBase* call,
                                       const ::bosdyn::api::spot_cam::ListSoundsRequest& request,
                                       ::bosdyn::api::spot_cam::ListSoundsResponse&& response,
                                       const grpc::Status& status,
                                       std::promise<ListSoundsResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::ListSoundsResponse>(
            status, response, SDKErrorCode::Success);
...
SetVolumeResultType AudioClient::SetVolume(float percentage, const RPCParameters& parameters) {
    return SetVolumeAsync(percentage, parameters).get();
}

std::shared_future<SetVolumeResultType> AudioClient::SetVolumeAsync(
    ::bosdyn::api::spot_cam::SetVolumeRequest& request, const RPCParameters& parameters) {
    std::promise<SetVolumeResultType> response;
    std::shared_future<SetVolumeResultType> future = response.get_future();
    BOSDYN_ASSERT_PRECONDITION(m_stub != nullptr, "Stub for service is unset!");

    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::SetVolumeRequest,
...
SetVolumeResultType AudioClient::SetVolume(::bosdyn::api::spot_cam::SetVolumeRequest& request,
                                           const RPCParameters& parameters) {
    return SetVolumeAsync(request, parameters).get();
}

void AudioClient::OnSetVolumeComplete(MessagePumpCallBase* call,
                                      const ::bosdyn::api::spot_cam::SetVolumeRequest& request,
                                      ::bosdyn::api::spot_cam::SetVolumeResponse&& response,
                                      const grpc::Status& status,
                                      std::promise<SetVolumeResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::SetVolumeResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<GetVolumeResultType> AudioClient::GetVolumeAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::GetVolumeRequest,
...
GetVolumeResultType AudioClient::GetVolume(const RPCParameters& parameters) {
    return GetVolumeAsync(parameters).get();
}

void AudioClient::OnGetVolumeComplete(MessagePumpCallBase* call,
                                      const ::bosdyn::api::spot_cam::GetVolumeRequest& request,
                                      ::bosdyn::api::spot_cam::GetVolumeResponse&& response,
                                      const grpc::Status& status,
                                      std::promise<GetVolumeResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::GetVolumeResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<SetAudioCaptureChannelResultType> AudioClient::SetAudioCaptureChannelAsync(
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::spot_cam::SetAudioCaptureChannelRequest,
...
void AudioClient::OnSetAudioCaptureChannelComplete(
    ...
    const ::bosdyn::api::spot_cam::SetAudioCaptureChannelRequest& request,
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::SetAudioCaptureChannelResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<GetAudioCaptureChannelResultType> AudioClient::GetAudioCaptureChannelAsync(
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::spot_cam::GetAudioCaptureChannelRequest,
...
void AudioClient::OnGetAudioCaptureChannelComplete(
    MessagePumpCallBase* call,
    const ::bosdyn::api::spot_cam::GetAudioCaptureChannelRequest& request,
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::GetAudioCaptureChannelResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<SetAudioCaptureGainResultType> AudioClient::SetAudioCaptureGainAsync(
    ::bosdyn::api::spot_cam::SetAudioCaptureGainRequest& request, const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::spot_cam::SetAudioCaptureGainRequest,
...
void AudioClient::OnSetAudioCaptureGainComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::SetAudioCaptureGainResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<GetAudioCaptureGainResultType> AudioClient::GetAudioCaptureGainAsync(
    ::bosdyn::api::spot_cam::GetAudioCaptureGainRequest& request, const RPCParameters& parameters) {
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::spot_cam::GetAudioCaptureGainRequest,
...
void AudioClient::OnGetAudioCaptureGainComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::GetAudioCaptureGainResponse>(
            status, response, SDKErrorCode::Success);
