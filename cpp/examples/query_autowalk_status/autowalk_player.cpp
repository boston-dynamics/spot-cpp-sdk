...
::bosdyn::common::Status AutowalkPlayer::LoadAutowalk(const std::filesystem::path& walk_folder) {
    // Read walk from file
    const std::filesystem::path walk_path =
        walk_folder / ::bosdyn::common::kMissionsDir / ::bosdyn::common::kAutowalkFile;
